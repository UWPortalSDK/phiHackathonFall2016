...
.controller('phiHackathonFall2016Ctrl', ['$scope', function ($scope) {
	...
	$scope.portalHelpers.showView('phiHackathonFall2016Main.html', 1);
	
	// This function gets called when user clicks an item in the list
	$scope.showDetails = function(item){
		// Make the item that user clicked available to the template
		$scope.detailsItem = item;		
		$scope.portalHelpers.showView('phiHackathonFall2016Details.html', 2);
	}
}]);